  ...
  return (
    <>
      <div className="overflow-hidden my-6 px-1">
        ...
        >
          <SwiperSlide>
            <div className="card  text-start bg-[#FCEBEA] rounded-[20px] flex md:bg-[url(/images/home/offer_img.png)] bg-no-repeat px-10 bg-right bg-size-[50%_100%] ">
              <div className="content md:basis-6/12 mt-18.25">
