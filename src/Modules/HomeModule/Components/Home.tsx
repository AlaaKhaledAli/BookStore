  ...
  return (
    <>
      ...
      <div className="page-navbar my-5">
        <nav className="desktop-nav lg:flex justify-between items-center flex-wrap mx-8 hidden ">
        ...
        <nav className="phone-nav flex justify-between items-center flex-wrap mx-8 lg:hidden">
          <div className="avatar">
            <div className="w-10 h-10 bg-gray-500 rounded-full "></div>
          </div>
          <i className='' onClick={()=>{setIsCollapsed(!isCollapsed)}}>
          ...
          <div className={`nav-content ${isCollapsed?"block":"hidden"} basis-12/12`}>
            <div className="links uppercase text-[#111111] ">
              <ul className=" mx-auto flex-col gap-y-15 flex-wrap">
                <li className=" pb-5 border-[#D1D1D1]  active:text-[#ED553B] ">
                  <Link to="/">Home</Link>
                </li>
                <li className=" pb-5 border-[#D1D1D1]">
                  <Link to="/about">About</Link>
                </li>
                <li className=" pb-5 border-[#D1D1D1]">
                  <Link to="/listing-books"> BOOKS</Link>
      ...
      <section id="categories">
        <div className="categories px-10 my-10">
          <div className="heading flex gap-2 items-center relative">
      ...
      <section id="new-release">
        <div className="new-release pb-8 my-10 bg-[#FCECEC] text-center pt-17.5">
          <h3 className=' text-[#7A7A7A] text-3.25 tracking-[12%]'>Some quality items</h3>
          <div className="header  bg-[#E0E0E0] w-full h-px  mt-25 md:mt-15  mb-0 pb-0"></div>
          <h2 className="text-[48px] text-[#393280] bg-[#FCECEC] w-fit mx-auto  my-0 py-0 translate-y-[-50%] font-semibold  text-center  px-5">New Release Books</h2>
      ...
      <section id="newsletter">
        <div className="newsletter bg-[#FCEBEA] pb-20">
          <div className="content bg-[#ED553B] text-center text-white  lg:w-[80%] mx-auto px-[12%] pb-15">
            <h2 className=" font-bold text-[46px] md:text-[56px]">Subscibe to Our Newsletter</h2>
          ...
          <div className="mail-box bg-white flex justify-between p-5 -translate-y-1/2 sm:w-[85%] lg:w-[50%] mx-auto">
      ...
      <section id="new-release">
        <div className="new-release pb-8 my-10 bg-[#F7FCFC] text-center">
          ...
          <div className="header  bg-[#E0E0E0] w-full h-px  mt-25 md:mt-15  mb-0 pb-0"></div>
          <h2 className="text-[48px] text-[#393280] bg-[#F7FCFC] w-fit mx-auto  my-0 py-0 translate-y-[-50%] font-semibold  text-center  px-5">Latest Articles</h2>
          <div className="swiper-container  px-10">
            <ArticlesSwiper />
          </div>
